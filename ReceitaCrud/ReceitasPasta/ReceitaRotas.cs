using System;
using ReceitaCrud.ReceitasPasta.Dtos;
...
public static class ReceitaRotas
{
    public static void AdicionarRotasdeReceita(this WebApplication app)
    {
        ...
        rotasReceita.MapPost("", async (CriarReceitaRequest request, ApplicationDbContext context) =>
        {
            ...
            var novaReceita = new Receita(request.Nome, request.TempoPreparo, request.CustoAproximado);
        ...
        rotasReceita.MapGet("{id:int}", async (int id, ApplicationDbContext context) =>
        {
